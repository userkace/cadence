  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: eventData.savedEvents.length, // Use filtered list length
        itemBuilder: (context, index) {
          final jsonLine = eventData.savedEvents[index];
          final venue =
      ...
      // body: ListView.builder(
      //   itemCount: eventData.savedEvents.length,
      //   itemBuilder: (context, index) {
      //     final event = eventData.savedEvents[index];
      //     return ListTile(
